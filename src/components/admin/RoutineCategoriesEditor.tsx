...
const API = "https://functions.poehali.dev/71168178-29a2-4a26-854e-043d0d622df7";
...
function RoutineCategoriesEditor({ onClose }: { onClose: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-background" style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <div className="flex items-center justify-between px-6 py-3.5 border-b border-border bg-card flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold">Рутина: вид деятельности</span>
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
          <p className="text-xs text-muted-foreground">
            Изменения сразу отображаются в модальном окне регистрации рутинной работы у специалистов ОТ.
          </p>
...
export default RoutineCategoriesEditor;
