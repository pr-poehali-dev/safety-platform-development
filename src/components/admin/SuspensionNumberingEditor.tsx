...
const API = "https://functions.poehali.dev/bcc14bec-45e7-4857-867d-95233fa38b64?type=numbering";
...
function SuspensionNumberingEditor({ onClose }: { onClose: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-background" style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}>
      <div className="flex items-center justify-between px-6 py-3.5 border-b border-border bg-card flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold">Настройки нумерации Приостановок</span>
        </div>
      ...
      <div className="flex-1 overflow-auto">
        <div className="max-w-xl mx-auto px-6 py-8 space-y-6">
          <p className="text-xs text-muted-foreground">
            Настройки применяются к новым актам о приостановке. Уже созданные номера не изменятся.
          </p>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="bg-secondary/30 border border-border rounded-lg px-4 py-3 flex items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">Следующий номер акта:</span>
...
export default SuspensionNumberingEditor;
