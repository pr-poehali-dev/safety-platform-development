...
import ViolationPlacesEditor from "./ViolationPlacesEditor";
...
export function DataTab() {
  ...
  return (
    <>
        ...
        >
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-foreground truncate">Место нарушения</p>
                <p className="text-[10px] text-muted-foreground">Выпадающий список</p>
              </div>
            </div>
            <div className="p-1.5 rounded text-muted-foreground hover:text-foreground hover:bg-secondary transition-colors">
      ...
      {openPlaces && <ViolationPlacesEditor onClose={() => setOpenPlaces(false)} />}
    </>
  );
}